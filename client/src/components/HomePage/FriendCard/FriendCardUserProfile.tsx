...
import FollowButtonUserProfile from '../../Button/FollowButtonUserProfile';
...
function FriendCardUserProfile({
  userFriend, friendIdArray,
}: FriendCardProps) {
...
export default FriendCardUserProfile;
